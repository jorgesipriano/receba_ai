 ...
 * Agora entende o preço unitário e calcula o total.
...
export async function processarComandoBar(msg, sock) {
    ...
    // O orquestrador já deve ter verificado a conta, mas por segurança:
...
_(Lança 2 coxinhas a R$5 cada, e 1 suco a R$4)_`;
    ...
    // --- LÓGICA DE REGISTRO DE VENDA (TEXTO LIVRE - v3.0) ---
    try {
        ...
        // Lógica de limite de crédito (assumindo que a tabela 'contas' tenha um campo 'limite_fiado')
